...
public class AlumnoDAOAPIImpl implements AlumnoDAO {
    ...
    public void insert(Alumno alum) {
        String url = "http://quieromititulo.com:9000/api/alumno";
    ...
    public void delete(Long id) {
        String url = "http://quieromititulo.com:9000/api/alumno/"+id;
    ...
    public List<Alumno> listaAlumDAO() {
        String url = "http://quieromititulo.com:9000/api/alumnos";
        OkHttpClient cliente = new OkHttpClient();
        Request request = new Request.Builder()
                .url(url)
                .build();
